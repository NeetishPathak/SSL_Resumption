...
#if(TESTCASE == TLS1_2_NO_RESUMPTION)
#define SESS_RESUME FALSE
#define TLSv1_3 FALSE
#define NO_SESSION_TICKETS TRUE

#elif(TESTCASE == TLS1_2_SESSION_IDS)
#define SESS_RESUME TRUE
#define TLSv1_3 FALSE
#define NO_SESSION_TICKETS TRUE

#elif(TESTCASE == TLS1_2_SESSION_TICKETS)
#define SESS_RESUME TRUE
#define TLSv1_3 FALSE
#define NO_SESSION_TICKETS FALSE

#elif(TESTCASE == TLS1_3_NO_RESUMPTION)
#define SESS_RESUME FALSE
#define TLSv1_3 TRUE
#define NO_SESSION_TICKETS FALSE

#elif(TESTCASE == TLS1_3_PSK)
